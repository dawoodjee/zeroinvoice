...
if (! defined('APP_NAME')) {
    ...
    define('NINJA_CONTACT_URL', env('NINJA_CONTACT_URL', 'https://www.zeroinvoice.com/contact/'));
    define('NINJA_FROM_EMAIL', env('NINJA_FROM_EMAIL', 'maildelivery@zeroinvoice.com'));
    define('NINJA_IOS_APP_URL', 'https://itunes.apple.com/us/app/zeroi-invoice/id1435514417?ls=1&mt=8');
    define('NINJA_ANDROID_APP_URL', 'https://play.google.com/store/apps/details?id=com.zeroinvoice.flutter');
    ...
    define('REFERRAL_PROGRAM_URL', env('REFERRAL_PROGRAM_URL', 'https://www.zeroinvoice.com/referral-program/'));
