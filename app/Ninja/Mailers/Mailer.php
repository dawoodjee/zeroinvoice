...
class Mailer
{
    ...
    private function sendPostmarkMail($toEmail, $fromEmail, $fromName, $replyEmail, $subject, $views, $data = [])
    {
        ...
        if (strpos($htmlBody, 'cid:zeroinvoice-logo.png') !== false) {
            $attachments[] = PostmarkAttachment::fromFile(public_path('images/zeroinvoice-logo.png'), 'zeroinvoice-logo.png', null, 'cid:zeroinvoice-logo.png');
