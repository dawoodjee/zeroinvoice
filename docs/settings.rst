...
- **Logo**: Upload your company logo by clicking on the Choose File button. Browse your computer for the appropriate image file and upload it. Remember, the ZerosInvoice system supports JPEG, GIF and PNG file types. TIP: Once, you've uploaded your logo, the graphic image will appear on the page. Uploaded the wrong image? Got yourself a new logo? Click Remove logo, and upload a new one.
...
As the business owner, you are the primary user of your ZerosInvoice account, so you'll need to define your user details. (Alternatively, if you are setting up the account on behalf of someone else, you'll need to have their details handy.)
...
If you want to login to your ZerosInvoice account without a password, you can do so via your other online accounts. By linking your Google, Facebook, GitHub or LinkedIn account to your ZerosInvoice account, you enable one-click login that truly makes life simpler.

To enable one click login, click the blue Enable button. A drop down menu will open, giving you the option to select an online account. Choose the account you want, and you'll be redirected to the third party website to link your ZerosInvoice account. Follow the prompts to complete the process.

Referral URL
^^^^^^^^^^^^

Want to join our referral program and save money? Get your friends to sign up and receive a whopping discount on your ZerosInvoice fees.  To join the referral program, check the Enable box. To find out more about our referral program, go here.
...
The Localization page is the place to customize a bunch of settings that make your ZerosInvoice account feel like home.
...
The ZerosInvoice system sends automated emails notifying you about the status of invoices and quotes sent to clients. Set your notification preferences on the Email Notifications page.
...
Want to keep up to date with ZerosInvoice updates, features and news? Follow our feeds on Facebook and Twitter by clicking on the Follow buttons.
...
If you need to import data to your ZerosInvoice account, or, alternatively, if you need to export your ZerosInvoice invoicing data, you can do both from the Import / Export page.
...
Whether upgrading, downgrading or cancelling (we hope not!), manage your ZerosInvoice account via this page.
Plan Status
...
.. NOTE:: If you delete your ZerosInvoice account, all data is permanently erased. There is no undo option.

You'll be prompted to confirm the delete action, and to provide us with a reason to help us improve the ZerosInvoice experience.
