...
Well, it’s time to bill, and the Invoices function of Zero Invoice lets you get the job done fast and with perfect accuracy.
...
The life of an invoice in the Zero Invoice system is made up of a number of stages:
...
- **Orange button - Email Invoice**: Email the invoice directly via the Zero Invoice system to the email address specified for the client.
