...
return [
    ...
    // Marketing links
    'time_tracker_web_url' => env('TIME_TRACKER_WEB_URL', 'https://www.zeroinvoice.com/time-tracker'),
    'knowledge_base_url' => env('KNOWLEDGE_BASE_URL', 'https://www.zeroinvoice.com/knowledge-base/'),
    ...
    'terms_of_service_url' => [
        'hosted' => env('TERMS_OF_SERVICE_URL', 'https://www.zeroinvoice.com/terms/'),
        'selfhost' => env('TERMS_OF_SERVICE_URL', 'https://www.zeroinvoice.com/self-hosting-terms-service/'),
    ],

    'privacy_policy_url' => [
        'hosted' => env('PRIVACY_POLICY_URL', 'https://www.zeroinvoice.com/privacy-policy/'),
        'selfhost' => env('PRIVACY_POLICY_URL', 'https://www.zeroinvoice.com/self-hosting-privacy-data-control/'),
    ],
