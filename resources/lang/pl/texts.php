...
"Płatne z góry za kwartał :QUARTER+1" >> "Płatne z góry za kwartał Q2"',
    ...
    'confirmation_subject' => 'Potwierdzenie rejestracji konta w Zero Invoice',
    ...
    'email_from' => 'Zespół The Zero Invoice',
    ...
    'white_label_text' => 'Kup roczną licencję white label za $:price, aby usunąć wzmianki o Zero Invoice z faktur i portalu klienta.',
...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'export_help' => 'Użyj formatu JSON, jeśli planujesz zaimportować dane do Zero Invoice.<br/> Taki plik zawiera dane klientów, produkty, faktury, oferty i płatności.',
    ...
    'wepay_account_description' => 'Dostawca płatności dla Zero Invoice',
    ...
    'security_code_email_subject' => 'Kod bezpieczeństwa dla Zero Invoice Bot',
    ...
    'update_invoiceninja_title' => 'Zaktualizuj Zero Invoice',
    'update_invoiceninja_warning' => 'Przed przejściem na nową wersję Zero Invoice stwórz kopię bezpieczeństwa swojej bazy danych i plików.',
    'update_invoiceninja_available' => 'Nowa wersja Zero Invoice jest dostępna.',
    'update_invoiceninja_unavailable' => 'Nowa wersja Zero Invoice nie jest dostępna.',
