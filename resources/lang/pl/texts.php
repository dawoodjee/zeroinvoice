...
"Płatne z góry za kwartał :QUARTER+1" >> "Płatne z góry za kwartał Q2"',
    ...
    'confirmation_subject' => 'Potwierdzenie rejestracji konta w ZerosInvoice',
    ...
    'email_from' => 'Zespół The ZerosInvoice',
    ...
    'white_label_text' => 'Kup roczną licencję white label za $:price, aby usunąć wzmianki o ZerosInvoice z faktur i portalu klienta.',
...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'export_help' => 'Użyj formatu JSON, jeśli planujesz zaimportować dane do ZerosInvoice.<br/> Taki plik zawiera dane klientów, produkty, faktury, oferty i płatności.',
    ...
    'wepay_account_description' => 'Dostawca płatności dla ZerosInvoice',
    ...
    'security_code_email_subject' => 'Kod bezpieczeństwa dla ZerosInvoice Bot',
    ...
    'update_invoiceninja_title' => 'Zaktualizuj ZerosInvoice',
    'update_invoiceninja_warning' => 'Przed przejściem na nową wersję ZerosInvoice stwórz kopię bezpieczeństwa swojej bazy danych i plików.',
    'update_invoiceninja_available' => 'Nowa wersja ZerosInvoice jest dostępna.',
    'update_invoiceninja_unavailable' => 'Nowa wersja ZerosInvoice nie jest dostępna.',
