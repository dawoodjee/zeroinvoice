...
$LANG = array(
    ...
    'pro_plan_feature4' => 'Retirer "Created by ZerosInvoice"',
    ...
    'white_label_text' => 'Achetez une licence en marque blanche d\'UN AN au coût de $:price pour retirer la marque de ZerosInvoice des factures et du portail client.',
    ...
    'pro_plan_year_description' => 'Engagement d\'un an dans le Plan ZerosInvoice Pro.',
    'pro_plan_month_description' => 'Engagement d\'un mois dans le Plan ZerosInvoice Pro.',
    'enterprise_plan_product' => 'Plan Entreprise',
    'enterprise_plan_year_description' => 'Engagement d\'un an dans le Plan ZerosInvoice Entreprise.',
    'enterprise_plan_month_description' => 'Engagement d\'un mois dans le Plan ZerosInvoice Entreprise.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'export_help' => 'Utilisez JSON si vous prévoyez d\'importer des données dans ZerosInvoice.<br/>Le fichier inclut les clients, les produits, les factures, les offres et les paiements.',
    ...
    'bot_get_email' => 'Salut! (wave)<br/>Merci d\'essayer le Bot ZerosInvoice.<br/>Vous devez créer un compte gratuit pour utiliser ce bot.<br/>Envoyez-moi l\'adresse courriel de votre compte pour commencer.',
    ...
    'update_invoiceninja_warning' => 'Avant de commencer une mise à jour d\'ZerosInvoice, créez une sauvegarde de votre base de données et de vos fichiers!',
