...
$LANG = array(
    ...
    'confirmation_subject' => 'Bekräfta ditt ZerosInvoice konto',
    ...
    'pro_plan_success' => 'Tack för att du väljer ZerosInvoice\'s Pro!<p/>&nbsp;<br/>
    ...
    'pro_plan_feature4' => 'Radera "Skapad av ZerosInvoice"',
...
<p> Fakturor på en månadsvis eller årlig cykel, på eller före den dag de skapas kommer att bero på nästa månad. Fakturor som förfaller på den 29: e eller 30: e månader som inte har den dagen kommer att betalas den sista dagen i månaden. </ P> 
 ...
 <li> Är idagg en fredag, är förfallodagen den 1: a fredag efter. Förfallodagen kommer att vara nästa fredag, inte idag. 
    ...
    'white_label_text' => 'Köp ETT ÅR white label licens för $:price för att ta bort bort ZerosInvoice referens från faktura och klient portal.',
    ...
    'pro_plan_remove_logo' => ':link för att ta bort ZerosInvoice-logotypen genom att uppgradera till Pro nivå',
    ...
    'pro_plan_year_description' => 'Ett års registering på ZerosInvoice Pro nivå.',
    'pro_plan_month_description' => 'En månads registering på ZerosInvoice Pro nivå.',
    'enterprise_plan_product' => 'Enterprise nivå',
    'enterprise_plan_year_description' => 'Ett års registering på ZerosInvoice Enterprise nivån.',
    'enterprise_plan_month_description' => 'En månads registering på ZerosInvoice Enterprise nivån.',
...
När ni har pengarna, kom tillbaka till denna betalningsmetods sida och klicka på "Slutför verifikation" vid sidan om konto.',
    ...
    'export_help' => 'Använda JSON om du planerar att importera datan till ZerosInvoice.<br/>Filen innehåller kunder, produkter, fakturor, offerter och betalningar.',
...
Den här funktionen kräver att en produkt skapas och en betalningsgateway är konfigurerad.',
    ...
    'wepay_account_description' => 'Betalningsgateway för ZerosInvoice',
    ...
    'security_code_email_subject' => 'Säkerhetskod för ZerosInvoice Bot.',
    'security_code_email_line1' => 'Detta är din ZerosInvoice Bot säkerhetskod.',
    ...
    'update_invoiceninja_title' => 'Uppdatera ZerosInvoice',
    'update_invoiceninja_warning' => 'Innan ni uppgraderar ZerosInvoice, skapa en backup av er databaser och filer!',
    'update_invoiceninja_available' => 'En ny version av ZerosInvoice finns tillgänglig.',
    'update_invoiceninja_unavailable' => 'Ingen ny version av ZerosInvoice finns tillgänglig.',
