...
<li>"เงินประกันสำหรับ :QUARTER+1" >> " ดำเนินการชำระเงินในไตรมาศที่ 2"</li>
    ...
    'pro_plan_success' => 'ขอขอบคุณที่เลือกแผน Pro Pro ของ Zero Invoice!<p/>&nbsp;<br/>
...
-- ส่งอีเมลมาที่ contact@zeroinvoice.com',
    ...
    'app_description' => 'Zero Invoice เป็นโซลูชันโอเพนซอร์สฟรีสำหรับลูกค้าที่ออกใบแจ้งหนี้และเรียกเก็บเงิน ด้วย Zero Invoice คุณสามารถสร้างและส่งใบแจ้งหนี้ที่สวยงามได้จากอุปกรณ์ใด ๆ ที่สามารถเข้าถึงเว็บได้ ลูกค้าของคุณสามารถพิมพ์ใบแจ้งหนี้ของคุณดาวน์โหลดเป็นไฟล์ PDF และคุณจ่ายเงินออนไลน์จากภายในระบบของเราได้เลย',
    'rows' => 'แถว',
    'www' => 'www',
    'logo' => 'www',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'เอา  "Created by Zero Invoice" ออก',
...
แปลงใบเสนอราคาให้เป็นใบแจ้งหนี้โดยอัตโนมัติเมื่อได้รับอนุมัติจากลูกค้า',
    ...
    'pro_plan_remove_logo' => ':link ลบโลโก้ Zero Invoice โดยการเข้าร่วม Pro Plan',
    ...
    'pro_plan_year_description' => 'การลงทะเบียนหนึ่งปีสำหรับ   Zero Invoice Pro Plan',
    'pro_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Zero Invoice Pro Plan.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'ลงทะเบียนหนึ่งปีสำหรับ Zero Invoice Enterprise Plan.',
    'enterprise_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Zero Invoice Enterprise Plan.',
    ...
    'export_help' => 'ใช้ JSON ถ้าคุณวางแผนที่จะนำเข้าข้อมูลลงใน Zero Invoice. <br/> ไฟล์ประกอบด้วยลูกค้า, สินค้า, ใบแจ้งหนี้, ใบเสนอราคา และการชำระเงิน.',
    ...
    'wepay_account_description' => 'เกตเวย์การชำระเงินสำหรับ Zero Invoice',
    ...
    'security_code_email_subject' => 'รหัสรักษาความปลอดภัยสำหรับ  Zero Invoice Bot',
    ...
    'update_invoiceninja_title' => 'อัปเดท Zero Invoice',
    'update_invoiceninja_warning' => 'ก่อนที่จะเริ่มต้นการอัพเกรด Zero Invoice กรุณาสำรองฐานข้อมูลและไฟล์ของคุณ!',
    'update_invoiceninja_available' => 'มีเวอร์ชันใหม่ของ Zero Invoice ให้ใช้งาน',
    'update_invoiceninja_unavailable' => 'ไม่มีเวอร์ชันใหม่ของ Zero Invoice available.',
