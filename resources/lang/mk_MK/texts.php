...
<li> "Задржано плаќање за :QUARTER+1" >> "Задржано плаќање за К2" </li>
    ...
    'confirmation_subject' => 'Потврдување на ZerosInvoice сметка',
    ...
    'email_from' => 'Тимот на ZerosInvoice',
    ...
    'pro_plan_success' => 'Ви благодариме што го избравте Про планот на ZerosInvoice! <p/> &nbsp; <br/>
 ...
 --пратете ни е-пошта на contact@zeroinvoice.com',
    ...
    'app_description' => 'ZerosInvoice е бесплатно, отворено решение за фактурирање и наплата на клиенти. Со ZerosInvoice, можете лесно да создадете и да пратите прекрасни фактури од било кој уред кој има пристап до веб. Вашите клиенти можат да ја испечатат фактурата, да ја преземат како pdf датотека и дури да платат онлајн во системот.',
    'rows' => 'Редови',
    'www' => 'www',
    'logo' => 'Лого',
    'subdomain' => 'Поддомен',
    ...
    'pro_plan_feature4' => 'Отстрани "Креирано со ZerosInvoice"',
 ...
 <li> Денес е петок, датумот на достасување е првиот петок потоа. Датумот на достасување би бил наредниот петок, не денес. 
    ...
    'white_label_text' => 'Купете ЕДНОГОДИШЕН ПЛАН за брендирана лиценца за $:price за да го отстраните брендирањето на ZerosInvoice од клиентскиот портал.',
    ...
    'pro_plan_remove_logo' => ':link за отстранување на ZerosInvoice логото со приклучување на Pro планот',
    ...
    'pro_plan_year_description' => 'Една година запишување на ZerosInvoice Pro планот.',
    'pro_plan_month_description' => 'Еден месец запишување на ZerosInvoice Pro планот.',
    'enterprise_plan_product' => 'План за претпријатие',
    'enterprise_plan_year_description' => 'Една година запишување на ZerosInvoice Pro планот за претпријатие.',
    'enterprise_plan_month_description' => 'Еден месец запишување на ZerosInvoice Pro планот за претпријатие.',
...
Откако ќе ги добиете износите, вратете се на оваа страница за начин на плаќање и кликнете "Заврши Верификација" до сметката.',
    ...
    'export_help' => 'Користи JSON ако планираш да ги внесеш информациите во ZerosInvoice. <br/> Датотеката содржи клиенти, продукти, фактури, понуди и плаќања.',
    ...
    'wepay_account_description' => 'Платен портал за ZerosInvoice',
    ...
    'bot_get_email' => 'Здраво! (wave) <br/> Ви благодарам што го пробавте ZerosInvoice ботот. <br/> Треба да креирате бесплатна сметка за да го користите овој бот. <br/> Испратете ми ја адресата на вашата е-пошта со која е поврзана сметката за да започнеме.',
    ...
    'security_code_email_subject' => 'Сигурносен код за ZerosInvoice ботот',
    'security_code_email_line1' => 'Ова е вашиот ZerosInvoice Bot сигурносен код.',
    ...
    'update_invoiceninja_title' => 'Ажурирај ZerosInvoice',
    'update_invoiceninja_warning' => 'Пред за започнете со ажурирање на ZerosInvoice креирајте бекап на вашата датабаза и датотеки.',
    'update_invoiceninja_available' => 'Достапна е нова верзија на ZerosInvoice.',
    'update_invoiceninja_unavailable' => 'Нема достапна нова верзија на ZerosInvoice.',
