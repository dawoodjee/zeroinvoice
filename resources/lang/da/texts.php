...
$LANG = array(
    ...
    'confirmation_subject' => 'Bekræftelse af Zero Invoice-konto',
    ...
    'email_from' => 'Zero Invoice Teamet',
    ...
    'pro_plan_success' => 'Tak fordi du valgte Zero Invoice\'s Pro plan!<p/>&nbsp;<br/>
                  ...
                  -- kontakt os på contact@zeroinvoice.com',
    ...
    'app_description' => 'Zero Invoice er en gratis, open-source løsning til at håndtere fakturering og betaling af dine kunder. Med Zero Invoice, kan du let generere og sende smukke fakturaer fra et hvilket som helst udstyr der har adgang til internettet. Dine klienter kan udskrive dine fakturarer, hente dem som PDF filer, og endda betale dem on-line inde fra Zero Invoice.',
    'rows' => 'rækker',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'pro_plan_feature4' => 'Fjern "Created by Zero Invoice"',
...
<p>Hvis du har brug for hjælp, send et spørgsmål til vores: forum_link med det design, du bruger.</p>',
    ...
    'white_label_text' => 'Køb en ONE YEAR white label-licens til $: pris for at fjerne Zero Invoice-branding fra fakturaen og klientportalen.',
    ...
    'pro_plan_remove_logo' => ':link for at fjerne Zero Invoice-logoet, opgrader til en Pro Plan',
    ...
    'export_help' => 'Brug JSON, hvis du planlægger at importere dataene til Zero Invoice.<br/>Filen inkluderer klienter, produkter, fakturaer, tilbud og betalinger.',
    ...
    'wepay_account_description' => 'Betalingsgateway til Zero Invoice',
    ...
    'bot_get_email' => 'Hej!<br/>Tak, fordi du prøvede Zero Invoice Bot.<br/>Du skal oprette en gratis konto for at bruge denne bot.<br/>Send mig din e-mail-adresse til din konto for at komme i gang.',
    ...
    'security_code_email_subject' => 'Sikkerhedskode til Zero Invoice Bot',
    'security_code_email_line1' => 'Dette er din Zero Invoice Bot sikkerhedskode.',
    ...
    'warning' => 'Advarsel',
    'self-update' => 'Opdatér',
    'update_invoiceninja_title' => 'Opdatér Zero Invoice',
    'update_invoiceninja_warning' => 'Før du starter opgraderingen af Zero Invoice, opret en sikkerhedskopi af din database og filer!',
    'update_invoiceninja_available' => 'En ny version af Zero Invoice er tilgængelig.',
    'update_invoiceninja_unavailable' => 'Der er ingen ny version af Zero Invoice tilgængelig.',
