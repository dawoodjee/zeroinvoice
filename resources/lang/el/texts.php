...
<li>"Προκαταβολή πληρωμής για το :QUARTER+1" >> "Προκαταβολή πληρωμής για το Τρίμηνο 2"</li>
    ...
    'confirmation_subject' => 'Επιβεβαίωση Λογαριασμού Zero Invoice',
    ...
    'email_from' => 'Η Ομάδα του Zero Invoice',
    ...
    'pro_plan_success' => 'Ευχαριστούμε που επιλέξατε το Zero Invoice\'s Pro plan!<p/>&nbsp;<br/>
...
να σας βοηθήσουμε. Στείλτε μας email στο contact@zeroinvoice.com\',',
    ...
    'pro_plan_feature4' => 'Αφαίρεση του "Created by Zero Invoice"',
    ...
    'pro_plan_remove_logo' => ':link για να αφαιρέσετε το λογότυπο Zero Invoice και να συμμετέχετε στο Επαγγελματικό Πλάνο',
    ...
    'pro_plan_year_description' => 'Ένα έτος εγγραφή στο Επαγγελματικό Πλάνο του Zero Invoice.',
    'pro_plan_month_description' => 'Ένας μήνας εγγραφή στο Επαγγελματικό Πλάνο του Zero Invoice.',
    'enterprise_plan_product' => 'Πλάνο Enterprise',
    'enterprise_plan_year_description' => 'Ένα έτος εγγραφή στο Εταιρικό Πλάνο του Zero Invoice.',
    'enterprise_plan_month_description' => 'Ένας μήνας εγγραφή στο Εταιρικό Πλάνο του Zero Invoice.',
    ...
    'export_help' => 'Χρησιμοποιήστε JSON εάν σχεδιάζετε να εισάγετε δεδομένα στο Zero Invoice.<br/>Το αρχείο περιλαμβάνει πελάτες, προϊόντα, τιμολόγια, προσφορές και πληρωμές.',
    ...
    'wepay_account_description' => 'Πύλη Πληρωμών (Gateway) για το Zero Invoice',
    ...
    'bot_get_email' => 'Γειά! (wave)<br/>Ευχαριστώ που δοκιμάσατε τον αυτοματισμό του Zero Invoice.<br/>Θα πρέπει να δημιουργήσετε ένα δωρεάν λογαριασμό για να χρησιμοποιήσετε αυτό τον αυτοματισμό.<br/>Στείλτε μου την διεύθυνση email σας για να ξεκινήσετε.',
    ...
    'security_code_email_subject' => 'Κωδικός ασφαλείας για τον αυτοματισμό Zero Invoice',
    'security_code_email_line1' => 'Αυτός είναι ο κωδικός ασφαλείας για τον αυτοματισμό Zero Invoice',
    ...
    'update_invoiceninja_title' => 'Ενημέρωση Zero Invoice',
    'update_invoiceninja_warning' => 'Πριν αρχίσετε την αναβάθμιση του Zero Invoice, δημιουργήστε ένα αντίγραφο ασφαλείας της βάσης δεδομένων και των αρχείων!',
    'update_invoiceninja_available' => 'Υπάρχει διαθέσιμη νεότερη έκδοση του Zero Invoice.',
    'update_invoiceninja_unavailable' => 'Δεν υπάρχει νεότερη έκδοση του Zero Invoice διαθέσιμη.',
...
<ul><li>Ευέλικτες πιστωτικές λύσεις και factoring τιμολογίων.</li></ul>',
    ...
    'local_part_help' => 'Προσαρμόστε το τοπικό τμήμα από τα εισερχόμενα αιτήματα υποστήριξης πχ. YOUR_NAME@support.zeroinvoice.com',
