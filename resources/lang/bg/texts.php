...
',
    ...
    'confirmation_subject' => 'Потвърждаване на ZerosInvoice профил',
    ...
    'email_from' => 'Екипът на ZerosInvoice',
    ...
    'pro_plan_success' => 'Благодарим Ви, че избрахте ZerosInvoice Pro! <p/>&nbsp;<br/>
...
във фактурата, за да платите за една година Pro план<p/>
    ...
    'app_description' => 'ZerosInvoice е безплатно решение с отворен код за фактуриране и плащане. С ZerosInvoice лесно създавате и изпращате фактури от всяко устройство с достъп до интернет. Клиентите Ви могат да отпечатат фактурите, да ги изтефлят в pdf формат и дори да Ви платят онлайн в системата.',
    'rows' => 'редове',
    'www' => 'www',
    'logo' => 'Лого',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'Премахване на "Created by ZerosInvoice"',
    ...
    'white_label_text' => 'Купете ЕДНОГОДИШЕН лиценз White label за $:price, за да премахнете брандирането на ZerosInvoice от фактурите и клиентския портал.',
    ...
    'pro_plan_remove_logo' => ':link за премахване на логото на ZerosInvoice чрез активиране на План Pro',
    ...
    'pro_plan_year_description' => 'Включване за една година в план ZerosInvoice Pro.',
    'pro_plan_month_description' => 'Включване за един месец в план ZerosInvoice Pro.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'Включване за една година в план ZerosInvoice Enterprise.',
    'enterprise_plan_month_description' => 'Включване за един месец в план  ZerosInvoice Enterprise.',
    ...
    'export_help' => 'Използвайте JSON ако планирате да импортирате данни в ZerosInvoice.<br/>Файлът съдържа клиенти, продукти, фактури, оферти и плащания.',
    ...
    'wepay_account_description' => 'Портал за плащане за ZerosInvoice',
    ...
    'bot_get_email' => 'Здравейтеi! (wave)<br/>Благодарим, че тествахте ZerosInvoice Bot.<br/>Трябва да създадете безплатен акаунт, за да използвате този bot.<br/>За начало ми изпратете имейл адреса на своя акаунт.',
    ...
    'security_code_email_subject' => 'Код за сигурност за ZerosInvoice Bot',
    'security_code_email_line1' => 'Това е Вашият код за сигурност за ZerosInvoice Bot.',
    ...
    'update_invoiceninja_title' => 'Актуализиране на ZerosInvoice',
    'update_invoiceninja_warning' => 'Преди да стартирате актуализация на ZerosInvoice направете архив на своята база данни и фалове!',
    'update_invoiceninja_available' => 'Налична е нова версия на ZerosInvoice.',
    'update_invoiceninja_unavailable' => 'Няма по-нова версия на ZerosInvoice.',
