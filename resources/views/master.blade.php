...
<head>
    ...
    @else
        <title>{{ isset($title) ? ($title . ' | Zero Invoice') : ('Zero Invoice | ' . trans('texts.app_title')) }}</title>
        <meta name="description" content="{{ isset($description) ? $description : trans('texts.app_description') }}"/>
        <link href="{{ asset('favicon-v2.png') }}" rel="shortcut icon" type="image/png">

        <meta property="og:site_name" content="Zero Invoice"/>
        <meta property="og:url" content="{{ SITE_URL }}"/>
        <meta property="og:title" content="Zero Invoice"/>
        ...
        <meta name="apple-mobile-web-app-title" content="Zero Invoice">
        <meta name="application-name" content="Zero Invoice">
