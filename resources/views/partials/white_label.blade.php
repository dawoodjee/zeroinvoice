...
{!! link_to('https://www.zeroinvoice.com/?utm_source=powered_by', 'Invoice Ninja', ['target' => '_blank', 'title' => trans('texts.created_by', ['name' => 'Hillel Coren'])]) !!} -
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="panel-body">
          ...
          <br/>
          <p>{!! trans('texts.reseller_text', ['email' => HTML::mailto('contact@zeroinvoice.com')]) !!}</p>
        </div>
        </div>
        </div>
